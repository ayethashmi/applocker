...
public class MaxApps_AppsTinyDB {

    private SharedPreferences play_fof_preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public MaxApps_AppsTinyDB(Context appContext) {
        play_fof_preferences = PreferenceManager.getDefaultSharedPreferences(appContext);
    }
    ...
    public int getInt(String key) {
        return play_fof_preferences.getInt(key, 0);
    }
    ...
    public ArrayList<Integer> getListInt(String key) {
        String[] myList = TextUtils.split(play_fof_preferences.getString(key, ""), "‚‗‚");
    ...
    public long getLong(String key) {
        return play_fof_preferences.getLong(key, 0);
    }
    ...
    public float getFloat(String key) {
        return play_fof_preferences.getFloat(key, 0);
    }
    ...
    public String getString(String key) {
        return play_fof_preferences.getString(key, "");
    }
    ...
    public ArrayList<String> getListString(String key) {
        return new ArrayList<String>(Arrays.asList(TextUtils.split(play_fof_preferences.getString(key, ""), "‚‗‚")));
    }
    ...
    public boolean getBoolean(String key) {
        return play_fof_preferences.getBoolean(key, false);
    }
    ...
    public void putInt(String key, int value) {
        checkForNullKey(key);
        play_fof_preferences.edit().putInt(key, value).apply();
    }
    ...
    public void putListInt(String key, ArrayList<Integer> intList) {
        ...
        play_fof_preferences.edit().putString(key, TextUtils.join("‚‗‚", myIntList)).apply();
    }
    ...
    public void putLong(String key, long value) {
        checkForNullKey(key);
        play_fof_preferences.edit().putLong(key, value).apply();
    }
    ...
    public void putListLong(String key, ArrayList<Long> longList) {
        ...
        play_fof_preferences.edit().putString(key, TextUtils.join("‚‗‚", myLongList)).apply();
    }
    ...
    public void putFloat(String key, float value) {
        checkForNullKey(key);
        play_fof_preferences.edit().putFloat(key, value).apply();
    }
    ...
    public void putListDouble(String key, ArrayList<Double> doubleList) {
        ...
        play_fof_preferences.edit().putString(key, TextUtils.join("‚‗‚", myDoubleList)).apply();
    }
    ...
    public void putString(String key, String value) {
        ...
        play_fof_preferences.edit().putString(key, value).apply();
    }
    ...
    public void putListString(String key, ArrayList<String> stringList) {
        ...
        play_fof_preferences.edit().putString(key, TextUtils.join("‚‗‚", myStringList)).apply();
    }
    ...
    public void putBoolean(String key, boolean value) {
        checkForNullKey(key);
        play_fof_preferences.edit().putBoolean(key, value).apply();
    }
    ...
    public void remove(String key) {
        play_fof_preferences.edit().remove(key).apply();
    }
     ...
     */
    public void clear() {
        play_fof_preferences.edit().clear().apply();
    }
    ...
    public Map<String, ?> getAll() {
        return play_fof_preferences.getAll();
    }
    ...
    public void registerOnSharedPreferenceChangeListener(
        ...
        play_fof_preferences.registerOnSharedPreferenceChangeListener(listener);
    }
    ...
    public void unregisterOnSharedPreferenceChangeListener(
        ...
        play_fof_preferences.unregisterOnSharedPreferenceChangeListener(listener);
    }
